...
export default {
    ...
    render(h){
        ...
        [
            ...
            this.icon&&!this.loading?h('i',{class:this.icon},null):null
            this.loading?h('i',{class:'is-loading'},null):null    
        ]
    }
}
```
...
@mixin button-size($padding-vertical,$padding-horizontal,$font-size,$border-radius){
    ...
    &.is-circle {
        padding:$padding-vartical;
    }
}
```
# 按钮组
## @/components/element/button-group/index.js
```js
...
```
## @/components/element/button-group/src/ButtonGroup.vue
```html
<template>
...
import Icon from '@/components/element/icon';
import Button from '@/components/element/button'
import ButtonGroup from '@/components/element/button-group'
...
```
## @/assets/theme-chalk/button-group.scss
```scss
@import "./mixins/mixins.scss";
@import "./common/var.scss";
...
```
## 修改@/assets/theme-chalk/index.scss(集合样式)
```scss
@import './row.scss';
@import './col.scss';
@import './container.scss';
