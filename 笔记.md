...
export default {
    ...
    render(h){
        return h(this.tag,{
            class:['el-button',this.type?`el-button--${this.type}`:'']
        },this.$slot.default)
    }
}
```
...
$--button-default-font-color:#606266;

$--button-primary-background-color:#fff;
$--button-primary-border-color:#dcdfe6;
$--button-primary-font-color:#606266;

$--button-warning-background-color:#fff;
$--button-warning-border-color:#dcdfe6;
$--button-warning-font-color:#606266;

$--button-danger-background-color:#fff;
$--button-danger-border-color:#dcdfe6;
$--button-danger-font-color:#606266;

$--button-info-background-color:#fff;
$--button-info-border-color:#dcdfe6;
$--button-info-font-color:#606266;
